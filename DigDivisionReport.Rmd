...
相較於現行一層決行門檻「主要道路、挖掘長度50公尺以上」，一層決行案量約減少`r nrow(k.predict[(k.predict$Length>=50|k.predict$lev=="主要道路")&k.predict$year=="2019",])-sum(k.predict$one[k.predict$year=="2019"]=="一層")`件。
